 ...
 * license information.
 * 
 * Azure KeyVault Certificates SDK for JavaScript - 4.3.0
 */
'use strict';
 ...
 * @internal
 */
const withTrace$1 = createTraceFunction("Azure.KeyVault.Certificates.CertificateOperationPoller");
/**
...
class CertificateOperationPollOperation extends KeyVaultCertificatePollOperation {
     ...
     */
    cancelCertificateOperation(certificateName, options = {}) {
        return withTrace$1("cancelCertificateOperation", options, async (updatedOptions) => {
            const result = await this.client.updateCertificateOperation(this.vaultUrl, certificateName, true, updatedOptions);
            return getCertificateOperationFromCoreOperation(certificateName, this.vaultUrl, result._response.parsedBody);
        });
    }
     ...
     */
    getPlainCertificateOperation(certificateName, options = {}) {
        return withTrace$1("getPlainCertificateOperation", options, async (updatedOptions) => {
            const result = await this.client.getCertificateOperation(this.vaultUrl, certificateName, updatedOptions);
            return getCertificateOperationFromCoreOperation(certificateName, this.vaultUrl, result._response.parsedBody);
        });
    }
 ...
 * @internal
 */
const withTrace$3 = createTraceFunction("Azure.KeyVault.Certificates.RecoverDeletedCertificatePoller");
/**
...
class RecoverDeletedCertificatePollOperation extends KeyVaultCertificatePollOperation {
    ...
    recoverDeletedCertificate(certificateName, options = {}) {
        return withTrace$3("recoverDeletedCertificate", options, async (updatedOptions) => {
...
// Copyright (c) Microsoft Corporation.
const withTrace$4 = createTraceFunction("Azure.KeyVault.Certificates.CertificateClient");
/**
...
class CertificateClient {
    ...
    listPropertiesOfCertificatesPage(continuationState, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listPropertiesOfCertificatesPage_1() {
            if (continuationState.continuationToken == null) {
                ...
                const currentSetResponse = yield tslib.__await(withTrace$4("listPropertiesOfCertificates", optionsComplete, (updatedOptions) => this.client.getCertificates(this.vaultUrl, updatedOptions)));
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield tslib.__await(withTrace$4("listPropertiesOfCertificates", options, (updatedOptions) => this.client.getCertificates(continuationState.continuationToken, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield tslib.__await(currentSetResponse.value.map(getPropertiesFromCertificateBundle, this));
                }
    ...
    listPropertiesOfCertificateVersionsPage(certificateName, continuationState, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listPropertiesOfCertificateVersionsPage_1() {
            if (continuationState.continuationToken == null) {
                ...
                const currentSetResponse = yield tslib.__await(withTrace$4("listPropertiesOfCertificateVersions", optionsComplete, (updatedOptions) => this.client.getCertificateVersions(this.vaultUrl, certificateName, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield tslib.__await(currentSetResponse.value.map(getPropertiesFromCertificateBundle, this));
                }
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield tslib.__await(withTrace$4("listPropertiesOfCertificateVersions", options, (updatedOptions) => this.client.getCertificateVersions(continuationState.continuationToken, certificateName, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield tslib.__await(currentSetResponse.value.map(getPropertiesFromCertificateBundle, this));
                }
    ...
    deleteContacts(options = {}) {
        return withTrace$4("deleteContacts", options, async (updatedOptions) => {
    ...
    setContacts(contacts, options = {}) {
        ...
        return withTrace$4("setContacts", options, async (updatedOptions) => {
     ...
     */
    getContacts(options = {}) {
        return withTrace$4("getContacts", options, async (updatedOptions) => {
    ...
    listPropertiesOfIssuersPage(continuationState, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listPropertiesOfIssuersPage_1() {
            if (continuationState.continuationToken == null) {
                ...
                const currentSetResponse = yield tslib.__await(withTrace$4("listPropertiesOfIssuers", requestOptionsComplete, (updatedOptions) => this.client.getCertificateIssuers(this.vaultUrl, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield tslib.__await(withTrace$4("listPropertiesOfIssuers", options, (updatedOptions) => this.client.getCertificateIssuers(continuationState.continuationToken, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield tslib.__await(currentSetResponse.value);
                }
    ...
    createIssuer(issuerName, provider, options = {}) {
        return withTrace$4("createIssuer", options, async (updatedOptions) => {
    ...
    async updateIssuer(issuerName, options = {}) {
        return withTrace$4("updateIssuer", options, async (updatedOptions) => {
    ...
    getIssuer(issuerName, options = {}) {
        return withTrace$4("getIssuer", options, async (updatedOptions) => {
    ...
    deleteIssuer(issuerName, options = {}) {
        return withTrace$4("deleteIssuer", options, async (updatedOptions) => {
    ...
    getCertificateVersion(certificateName, version, options = {}) {
        return withTrace$4("getCertificateVersion", options, async (updatedOptions) => {
            if (!version) {
    ...
    importCertificate(certificateName, certificateBytes, options = {}) {
        return withTrace$4("importCertificate", options, async (updatedOptions) => {
            var _a;
    ...
    getCertificatePolicy(certificateName, options = {}) {
        return withTrace$4("getCertificatePolicy", options, async (updatedOptions) => {
    ...
    updateCertificatePolicy(certificateName, policy, options = {}) {
        return withTrace$4("updateCertificatePolicy", options, async (updatedOptions) => {
    ...
    updateCertificateProperties(certificateName, version, options = {}) {
        return withTrace$4("updateCertificateProperties", options, async (updatedOptions) => {
    ...
    deleteCertificateOperation(certificateName, options = {}) {
        return withTrace$4("deleteCertificateOperation", options, async (updatedOptions) => {
    ...
    mergeCertificate(certificateName, x509Certificates, options = {}) {
        return withTrace$4("mergeCertificate", options, async (updatedOptions) => {
    ...
    backupCertificate(certificateName, options = {}) {
        return withTrace$4("backupCertificate", options, async (updatedOptions) => {
    ...
    restoreCertificateBackup(backup, options = {}) {
        return withTrace$4("restoreCertificateBackup", options, async (updatedOptions) => {
    ...
    listDeletedCertificatesPage(continuationState, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listDeletedCertificatesPage_1() {
            if (continuationState.continuationToken == null) {
                ...
                const currentSetResponse = yield tslib.__await(withTrace$4("listDeletedCertificates", requestOptionsComplete, (updatedOptions) => this.client.getDeletedCertificates(this.vaultUrl, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield tslib.__await(withTrace$4("listDeletedCertificates", options, (updatedOptions) => this.client.getDeletedCertificates(continuationState.continuationToken, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield tslib.__await(currentSetResponse.value.map(getDeletedCertificateFromItem, this));
                }
    ...
    getDeletedCertificate(certificateName, options = {}) {
        return withTrace$4("getDeletedCertificate", options, async (updatedOptions) => {
            const result = await this.client.getDeletedCertificate(this.vaultUrl, certificateName, updatedOptions);
            return getDeletedCertificateFromDeletedCertificateBundle(result._response.parsedBody);
        });
    }
    ...
    async purgeDeletedCertificate(certificateName, options = {}) {
        return withTrace$4("purgeDeletedCertificate", options, async (updatedOptions) => {
